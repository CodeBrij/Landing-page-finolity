        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="hidden w-full md:flex md:w-auto md:items-center" id="navbar-default">
            ...
            <div className="md:ml-4">
              <button className="bg-[#d40000] px-4 py-2 rounded-md text-white text-sm font-medium hover:bg-[#b00000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#d40000]">
                Contact Us
              </button>
            </div>
          </div>
          ...
          {isMenuOpen && (
            <div className="w-full md:hidden" id="navbar-mobile">
              <ul className="font-medium flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                ...
                <li>
                  <button className="w-full bg-[#d40000] px-4 py-2 rounded-md text-white text-sm font-medium hover:bg-[#b00000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#d40000] mt-2">
                    Contact Us
                  </button>
                </li>
              </ul>
